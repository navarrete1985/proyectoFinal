        ...
        <div class="col-lg-12">
            <div class="cover-profile">
                <div class="profile-bg-img">
                    <div class="dynamic-bg bg profile-bg-image profile-bg-img img-fluid"
                        :style="{'background-image':`url(${imageBanner})`}"></div>
                    <!-- <img class="profile-bg-img img-fluid" src="http://localhost:3000/src/users/default-bg.jpg" alt="bg-img"> -->
                    <div class="card-block user-info">
                        <div class="col-md-12">
                            <div class="media-left">
                                <a href="#" class="profile-image">
                                    <div class="dynamic-bg bg user-img user-image img-radius"
                                        :style="{'background-image':`url(${imageProfile})`}" alt="user-image"></div>
                                </a>
                            </div>

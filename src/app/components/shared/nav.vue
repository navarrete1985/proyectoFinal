      ...
      >
        ...
        >
          <div
            ...
            style="position: relative; top: -11px; left: 0px; width: 100%;"
            dir="ltr"
          >
            ...
            <div class="pcoded-navigatio-lavel" menu-title-theme="theme5">UI Element</div>
            <ul
              class="pcoded-item pcoded-left-item"
              item-border="true"
              item-border-style="none"
            ...
            <div class="pcoded-navigatio-lavel" menu-title-theme="theme5">Forms</div>
            <ul
              class="pcoded-item pcoded-left-item"
              item-border="true"
              item-border-style="none"
            ...
            <div class="pcoded-navigatio-lavel" menu-title-theme="theme5">Tables</div>
            <ul
              class="pcoded-item pcoded-left-item"
              item-border="true"
              item-border-style="none"
            ...
            <div class="pcoded-navigatio-lavel" menu-title-theme="theme5">Chart And Maps</div>
            <ul
              class="pcoded-item pcoded-left-item"
              item-border="true"
              item-border-style="none"
            ...
            <div class="pcoded-navigatio-lavel" menu-title-theme="theme5">Pages</div>
            <ul
              class="pcoded-item pcoded-left-item"
              item-border="true"
              item-border-style="none"
            ...
            <div class="pcoded-navigatio-lavel" menu-title-theme="theme5">App</div>
            <ul
              class="pcoded-item pcoded-left-item"
              item-border="true"
              item-border-style="none"
            ...
            <div class="pcoded-navigatio-lavel" menu-title-theme="theme5">Extension</div>
            <ul
              class="pcoded-item pcoded-left-item"
              item-border="true"
              item-border-style="none"
            ...
            <div class="pcoded-navigatio-lavel" menu-title-theme="theme5">Other</div>
            <ul
              class="pcoded-item pcoded-left-item"
              item-border="true"
              item-border-style="none"
        ...
        >
          <div class="mCSB_draggerContainer">
            <div
              ...
              class="mCSB_dragger"
              style="position: absolute; min-height: 30px; display: block; height: 122px; max-height: 567px; top: 2px;"
            >

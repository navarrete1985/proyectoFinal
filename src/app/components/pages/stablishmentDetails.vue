                ...
                <div class="col-lg-12">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="personal" role="tabpanel">
                            <!-- personal card start -->
                            <div v-show="position === 0" class="card">
                                <div class="card-header">
                                    <h5 class="card-header-text">About Me</h5>
                                    <button id="edit-btn" type="button" @click="setDataInputs"
                                                                ...
                                                                <table class="table m-0">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <input type="text" v-model="stablishment.name"
                                                                        ...
                                                                        <tr>
                                                                            <th scope="row">Identificador de
                                                                                establecimiento</th>
                                                                            <input type="text" v-model="stablishment._id"
                                                                                :class="{'white':editInputs==true}"
                                                                                :readonly="!editInputs">
                                                                        </tr>
                                                                        <tr>
                                                                            <th scope="row">Uuid</th>
                                                                            <input type="text" v-model="stablishment.uuid"
                                                                                :class="{'white':editInputs==true}"
                                                                                :readonly="!editInputs">
                                                                        </tr>
                                                                        <tr>
                                                                            <th scope="row">Localización</th>
                                                                            <td :class="{'white':editInputs==true}">New
                                                                                York, USA</td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <textarea :class="{'white':editInputs==true}"
                                                                                v-model="stablishment.description"
                                                                                :readonly="!editInputs"></textarea>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                <button v-if="editInputs" id="edit-btn" type="button"
                                                                    @click="sendEdit"
                                                                    class="btn btn-sm btn-primary waves-effect waves-light f-right">
                                                                    <i class="icofont icofont-edit"></i>
                                                                    Guardar
                                ...
                                <!-- end of card-block -->
                                <!-- Inicio de carta para actividad en vivo -->
                            <div v-show="position === 3" class="card">
                                <div class="card-header">
...
export default {
    data() {
        return {
            loading: false,
            editInputs: false,
            tabs: ["Descripción", "Galeria", "Ofertas", "Actividad"],
            defaultUrlBanner: "http://localhost:3000/src/users/default-bg.jpg",
            position: 0,
            defaultUrlLogo: "http://localhost:3000/src/users/default.png",
            urlStablishment: window.location.origin + "/src/stablishments/" + this.$route.params.id + "/",
            position: 0,
        };
    },
    computed: {

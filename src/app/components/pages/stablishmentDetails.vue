<template>
  <div>
    ...
    <profile-header :imageProfile="urlStablishment+stablishment.image_logo" :imageBanner="urlStablishment+stablishment.photo_url[0]" ></profile-header>
    <div class="row">
      <div class="col-lg-12">
        <tab-menu></tab-menu>
        <!-- tab content start -->
...
export default {
  ...
  async beforeMount() {
    ...
    this.stablishment= await this.$store.dispatch(

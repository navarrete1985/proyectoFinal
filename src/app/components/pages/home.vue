<template>
  <baseComponent>
    ...
    <div class="col-11">
      ...
      <draggable :list="list" :disabled="!enabled" class="list-group mesas" ghost-class="ghost" @start="dragging = true"
        @end="dragging = false">
    ...
    <div class="col-11">
      ...
      <draggable :list="list" :disabled="!enabled" class="list-group mesas" ghost-class="ghost" @start="dragging = true"
        @end="dragging = false">
        <div class="list-group-item col-md-2" v-for="element in list2" :key="element.name">{{ element.name }}</div>
      </draggable>
    </div>
  </baseComponent>
</template>
